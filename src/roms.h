/* Embedded test ROMs. Public domain CHIP-8 programs widely
 * distributed in the community since the 1990s. */

#pragma once
#include <stdint.h>

/* IBM Logo by an unknown author, ~1980s. The classic "is your CHIP-8
 * working" test ROM — clears the screen, draws "IBM" using a series of
 * sprites, then loops forever. 132 bytes. */
static const uint8_t rom_ibm_logo[] = {
